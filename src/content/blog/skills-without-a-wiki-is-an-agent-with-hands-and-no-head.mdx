...
- Tier history backfills from billing events; gaps before 2025-Q4 default to flat-rate. ^[inferred]
- Whether [[entities/customer-portal-v2]] needs new UI for tier display is unresolved. ^[ambiguous]
